    ...
    addContact(datas)
    {
      ...
      //  this.setState({contacts:newRehber});
       ...
       // console.log("SAVED in Contact",datas);
        const {contacts}=this.state;//mevcut state degerini bir sabite ata
        contacts.push(datas);//gelen yeni veriyi bunun uzerine ekle
        this.setState({contacts})//son guncel degeri state e koy
    }
